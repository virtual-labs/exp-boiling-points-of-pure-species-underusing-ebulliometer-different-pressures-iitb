...
function a1_load_questions() {}
{
	...
	question.push({
		srno: 10,
		question:
			"Select <span style='color: #018fc3'> Differential Ebulliometer </span>",
...
function load_higlighted_images() {
	...
	a1_labels = [
		...
		new Chemistry.Text(
			'Ballast Tank',
			new Chemistry.Point(1700, 170),
			canvas
		),

		new Chemistry.Text(
			'Heating Tap',
			new Chemistry.Point(1400, 680),
			canvas
		),
		...
		new Chemistry.Text(
			'Vaccum Pump',
			new Chemistry.Point(1700, 690),
			canvas
		),

		new Chemistry.Text(
			'Temp Indicator',
			new Chemistry.Point(870, 800),
			canvas
		),

		new Chemistry.Text(
			'Differential Ebulliometer',
			new Chemistry.Point(1100, 300),
			canvas
		),
	];
}
